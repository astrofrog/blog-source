...
* The main reason for Python 2 users to not switch to Python 3 is the lack of
  ...
  encouraging people to switch to Python 3, by (a) making sure that any new users are always directed to the latest Python 3 version, and (b) in the near future, we start releasing new major versions of packages for Python 3 only, while maintaining long term bugfix support for Python 2 versions.
